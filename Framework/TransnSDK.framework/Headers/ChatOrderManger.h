...
@interface ChatOrderManger : NSObject

@property (nonatomic,strong)TransnOrder *currentOrder;
...
@property(nonatomic, strong) TransnTranslatorModel  *translator;// TRAPIDeprecated("使用新方法 currentOrder.translator");
...
//               playTime:(NSInteger)playTime didFinish:(void (^)(void))didFinish;
//
//
///**
