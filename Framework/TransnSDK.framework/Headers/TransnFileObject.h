 ...
 *    预约单内容类型枚举
 */
typedef NS_ENUM (NSInteger, TransnFileObjectType) {
    /*!翻译文本*/
    TransnFileObjectTypeText = 0,
    /*!翻译图片*/
    TransnFileObjectTypeImage = 1,
    //暂时没有语音消息
};


@interface TransnFileObject : NSObject
#pragma mark 上传文件请求参数
/*!
 *    预约单内容类型
 */
@property(nonatomic,assign)TransnFileObjectType type;
/*!
