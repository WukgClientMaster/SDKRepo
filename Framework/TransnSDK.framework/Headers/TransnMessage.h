...
@interface TransnMessage : NSObject

/**
 *   通过XMPPMsg创建一条消息，SDK内部使用
 *
 *   @param xmppMsg xmppMessage
 *   @return 返回一个TransnMessage对象
 */
...
/// 语音消息属性，发送语音文件时，对应的本地文件路径- (TransnMessage *)sendVoiceMessage:(NSString *)filePath voiceSize:(NSString *)voiceSize; 对应此方法中的filePath
...
@property (nonatomic, strong) TransnTranslatorModel *translatorMb;
