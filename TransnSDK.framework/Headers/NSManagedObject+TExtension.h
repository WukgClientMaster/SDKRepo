...
#import "TransnMessageManagedObject+CoreDataClass.h"
 ...
 */
+ (void)updateTranslator:(TransnTranslatorModel *)translator;

#pragma mark TransnMessage
...
/*!
 ...
 @param userId 当前用户ID
 */
+ (void)updateMessage:(TransnMessage *)message state:(TIMMessageSendState)state time:(int)time flowId:(NSString *)flowId userId:(NSString *)userId;
